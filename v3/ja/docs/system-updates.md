...
過去には[署名付きURL](abci-cloudstorage/presigned-urls.md)の有効期限に制限はありませんでしたが、4月３０日以降は、有効期限の最大値が7日間となります。

## 2026-03-11 {#2026-03-11}

2025年度末から、通信許可に期限が設定されることになりました。2025年度以降、通信許可は年度末で削除されます。2026年度以降は、毎年、通信許可を申請してください。
