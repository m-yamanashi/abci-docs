...
The communication will be permmited only for the ABCI groups whose ABCI application are submitted and approved together with the communication application. However, you can consult and submit an application on the communication permission by email before submitting the ABCI application.
